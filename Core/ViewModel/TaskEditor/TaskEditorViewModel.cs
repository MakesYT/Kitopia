...
public partial class TaskEditorViewModel : ObservableRecipient
{
    ...
    partial void OnIsSelectedChanged(int value)
    {
        if (value >= -1)
        {
            CanDel = true;
        ...
        OnPropertyChanged(nameof(CanDel));
        DelKeyCommand.NotifyCanExecuteChanged();
    }

    [ObservableProperty] private bool canDel = false;
    ...
    partial void OnKeyValueChanged(string value)
    {
    ...
    [ObservableProperty] private bool canAdd = false;
