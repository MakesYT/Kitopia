...
internal enum TextControlButtons
{
    ...
    Paste = 4,
    Bold = 8,
    Italic = 16, // 0x00000010
    Underline = 32, // 0x00000020
    Undo = 64, // 0x00000040
    Redo = 128, // 0x00000080
    SelectAll = 256, // 0x00000100
}
        ...
        else
        {
            switch (textControlButton)
            {
                case TextControlButtons.Cut:
                {
                    ...
                    InitializeButtonWithUICommand(button, new StandardUICommand(StandardUICommandKind.Cut),
                        ExecuteCutCommand);
                ...
                {
                    var button = new CommandBarButton();
                    InitializeButtonWithUICommand(button, new StandardUICommand(StandardUICommandKind.Copy),
                        ExecuteCopyCommand);
                ...
                {
                    var button = new CommandBarButton();
                    InitializeButtonWithUICommand(button, new StandardUICommand(StandardUICommandKind.Paste),
                        ExecutePasteCommand);
                ...
                {
                    var button = new CommandBarButton();
                    InitializeButtonWithUICommand(button, new StandardUICommand(StandardUICommandKind.Undo),
                        ExecuteUndoCommand);
                ...
                {
                    var button = new CommandBarButton();
                    InitializeButtonWithUICommand(button, new StandardUICommand(StandardUICommandKind.Redo),
                        ExecuteRedoCommand);
                ...
                {
                    var button = new CommandBarButton();
                    InitializeButtonWithUICommand(button, new StandardUICommand(StandardUICommandKind.SelectAll),
